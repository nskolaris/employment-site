...
<div class="row">
	<a class="item glyphicon glyphicon-file" href="<?php echo $this->Html->Url(array('controller'=>'avisos','action'=>'index')); ?>"><div class="text">Listado de avisos</div></a>
</div>
<div class="row">
	<a class="item glyphicon glyphicon-plus" href="<?php echo $this->Html->Url(array('controller'=>'avisos','action'=>'add')); ?>"><div class="text">Nuevo aviso</div></a>
</div>
<div class="row">
	<a class="item glyphicon glyphicon-shopping-cart" href="<?php echo $this->Html->Url(array('controller'=>'productos','action'=>'index')); ?>"><div class="text">Productos</div></a>
</div>