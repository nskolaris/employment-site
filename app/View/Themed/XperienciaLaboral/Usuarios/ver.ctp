<script>
	var user = JSON.parse('<?php echo json_encode($postulante); ?>');
	...
	function GetProfileImage(){
		$.post('<?php echo 'img/profile_pics/'.$postulante['Usuario']['id'].'.jpg'; ?>',null,function(response){
			if(response){
				$('.user-image').attr('src','<?php echo 'img/profile_pics/'.$postulante['Usuario']['id'].'.jpg'; ?>');
			} 
		})
	}
