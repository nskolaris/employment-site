...
class phpthumb { 
    ...
    var $phpthumb_version = '1.7.12-201311251521'; 
...
if ($this->sx || $this->sy || $this->sw || $this->sh) { 
    $this->DebugMessage('ImageMagickThumbnailToGD() aborting because source image region set (sx/sy/sw/sh)', __FILE__, __LINE__); 
    $this->useRawIMoutput = false; 
    return false; 
} 
*/ 
